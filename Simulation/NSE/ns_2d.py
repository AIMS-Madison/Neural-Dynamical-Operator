...
for j in range(N//bsize):
    ...
    #Solve NS
    sol, sol_t = navier_stokes_2d(w0, f, 1e-4, 20.0, 1e-4, record_steps)
...
with open("/home/cc/Downloads/NS/Data/NS_data_a.npy", "wb") as f:
    np.save(f, a)

with open("/home/cc/Downloads/NS/Data/NS_data.npy", "wb") as f:
    np.save(f, u)
